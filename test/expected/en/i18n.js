...
window.i18n["greetings"]["hello"] = function(d){return "this is my hello message"}
window.i18n["greetings"]["goodbye"] = function(d){return "farewell"}
window.i18n["greetings"]["people"] = function(d){return p(d,"PEOPLE",0,"en",{"one":n(d,"PEOPLE")+" person","other":n(d,"PEOPLE")+" people"})}
})();